...
pub extern "C" fn _start() -> ! {
    ...
    print("/|     THIS is Gina's Operating System :)     |\n");   
    print("/|\\cr I am a RED text                        |\n");   
    print("/|\\cg          GREEN text here               |\n");   
    print("/|\\cb                     This text is BLUE  |\n");  
    print("/|\\cwThis is default text.                   |\n");
    print("/|This is a new line.\tThis shows a tab.      |\n");
    print("/|                                            |\n");
    print("/---------------------------------------------\n");
    print("/////////////////////////////////////////////\n");
